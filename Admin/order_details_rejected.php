...
$sql="SELECT * FROM orders WHERE status = 'rejected' and ORDER_ID='$o'";
...
<form class='form-horizontal' role='form'>
  ...
  <div class='form-group'>
	<div class='col-sm-offset-2 col-sm-10'>
	  <a class='btn btn-primary' href='http://localhost/admin/orders_rejected.html' role='button'>Go back to the rejected order list</a>
	</div>
  </div>
</form>
</div>";
