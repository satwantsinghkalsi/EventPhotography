...
$sql="SELECT * FROM orders WHERE status = 'processing' and ORDER_ID='$o'";
...
<form class='form-horizontal' role='form'>
  ...
  <div class='form-group'>
	<label class='col-sm-2 control-label'>Event Creation Time</label>
	<div class='col-sm-10'>
	  <span class='form-control'>$creation_time</span>
    </div>
  </div>
  <div class='form-group'>
  ...
  <div class='form-group'>
	<div class='col-sm-offset-2 col-sm-10'>
	  <button type='Button' class='btn btn-success' onclick='processing_to_approved_rejected($order_id,\"approved\")'>Accept Order</button>
	  <button type='Button' class='btn btn-danger' onclick='processing_to_approved_rejected($order_id,\"rejected\")'>Reject Order</button>
	  <a class='btn btn-primary' href='http://localhost/admin/orders.html' role='button'>Go back to the order list</a>
	</div>
  </div>
</form>
</div>";
