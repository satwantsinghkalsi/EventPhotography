...
echo "<div class='content-box-header panel-heading'>
	<div class='panel-title'><b>Details for your order</b></div>
...
<form class='form-horizontal' role='form'>
  ...
  <div class='form-group'>
	<div class='col-sm-offset-2 col-sm-10'>
	  <a class='btn btn-primary' href='http://localhost/admin/customer_orders.html' role='button'>Go back to the order list</a>
	</div>
  </div>
</form>
</div>";
